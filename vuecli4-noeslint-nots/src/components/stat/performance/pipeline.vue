  ...
  <div class="pipelineTable"
    ...
    <div class="exportBtn"
      ...
      <unit-btn type='large right export'
                text='导出报表'
                @click="exportStat('pipeline')"></unit-btn>
    </div>
...
export default {
    ...
    return {
      ...
      titltList: {
        all: [
          ...
          { key: 'projNo', name: '项目编号', mustwidth: '130' },
          { key: 'customerName', name: '客户名称', mustwidth: '220' },
          { key: 'projName', name: '项目名称', mustwidth: '250' },
          { key: 'projAmount_', name: '项目金额<br/>/预计年合同额(元)', mustwidth: '140' },
          { key: 'projTypeTxt', name: '项目类型', mustwidth: '110' },
          { key: 'winRateTxt', name: '项目赢率', mustwidth: '120' },
          { key: 'projStageTxt', name: '项目阶段', mustwidth: '100' },
          { key: 'commitStatusTxt', name: 'commit状态', mustwidth: '100' },
          { key: 'commitConfirmTxt', name: 'commit确认', mustwidth: '100' },
          { key: 'projStatusTxt', name: '项目状态', mustwidth: '100' },
          { key: 'tenderTime_', name: '投标时间', mustwidth: '140' },
          { key: 'tenderResultTxt', name: '投标结果', mustwidth: '100' },
          { key: 'contractStatusTxt', name: '合同状态', mustwidth: '100' },
        ...
        system: [
          ...
          { key: 'commitStatus_', name: 'commit状态', mustwidth: '120' },
          { key: 'projStatusTxt', name: '项目状态', mustwidth: '120' },
          { key: 'planFinishTime_', name: '预计结案日期', mustwidth: '150' },
          { key: 'createTime_', name: '立项时间', mustwidth: '200' },
          { key: 'duration', name: '立项时长（天）', mustwidth: '120' },
          { key: 'contactName', name: '客户联系人', mustwidth: '120' },
          { key: 'policymarkerName', name: '决策人', mustwidth: '120' },
          { key: 'mainBrand', name: '主要品牌', mustwidth: '200' },
          { key: 'feasibilityTxt', name: '技术可行性判断', mustwidth: '200' },
          { key: 'feasibilityDesc', name: '技术可行性判断说明', mustwidth: '200' },
          { key: 'competitiveBrand', name: '竞争品牌', mustwidth: '200' },
          { key: 'competitor', name: '竞争对手', mustwidth: '200' },
          { key: 'competitiveAdvantage', name: '竞争优势', mustwidth: '200' },
          { key: 'competitiveWeakness', name: '竞争劣势', mustwidth: '200' },
          { key: 'companySupport', name: '需要公司层面支持', mustwidth: '200' },
        ...
        IDC: [
          ...
          { key: 'customerName', name: '客户名称', mustwidth: '220' },
          { key: 'customerLevelTxt', name: '客户等级', mustwidth: '200' },
          { key: 'projName', name: '项目名称', mustwidth: '250' },
          { key: 'projTypeTxt', name: '项目类型', mustwidth: '120' },
          { key: 'winRateTxt', name: '项目赢率', mustwidth: '150' },
          { key: 'estAnnualConAmount_', name: '预计年合同额（元）', mustwidth: '120' },
          { key: 'commitStatusTxt', name: 'commit状态', mustwidth: '120' },
          ...
          { key: 'others', name: '其他要求', mustwidth: '200' },
        ...
        switch (res.code) {
          case '0':
            switch (this.tab.choose) {
              case '1':
                this.title = this.titltList.all
                break
              case '2':
                this.title = this.titltList.system
                break
              case '3':
                this.title = this.titltList.IDC
                break
            }
    ...
    tableOper(key, item) {
      switch (key) {
        ...
        case 'projName':
          ...
          this.$pubfunc.setSStorage('tag', 'pipeline')
  ...
  created() {
    ...
    let tag = this.$pubfunc.getSStorage('tag'),
      judge = false
    this.$pubfunc.judgeBtn('performance:pipeline:sum')
      ? (this.tab.list.push({ id: '1', name: 'Pipeline-汇总' }),
        tag === 'Pipeline-汇总' ? (judge = true) : null)
      : null
    this.$pubfunc.judgeBtn('performance:pipeline:sysinte')
      ? (this.tab.list.push({ id: '2', name: 'Pipeline-系统集成项目' }),
        tag === 'Pipeline-系统集成项目' ? (judge = true) : null)
      : null
    this.$pubfunc.judgeBtn('performance:pipeline:idc')
      ? (this.tab.list.push({ id: '3', name: 'Pipeline-IDC项目' }),
        tag === 'Pipeline-IDC项目' ? (judge = true) : null)
      : null
