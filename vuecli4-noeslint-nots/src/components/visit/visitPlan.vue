        ...
        <el-scrollbar class="unitScrollbar"
          ...
          <div class="boxTable">
            ...
            <unit-table :total="total"
                        ...
                        :operation="[{key:'view',show:judgeShow},{key:'revise',show:judgeShow},{key:'delete',show:judgeShow,class:()=>{return 'redbtn'}},{key:'addVisit',show:judgeShow}]"
...
export default {
  name: 'visitPlan',
  props: ['dom'],
  components: { unitTable, unitTime,unitTree }, //unitProject,unitCustomer
  data () {
    ...
    return {
      selMod: {
        ...
        visitDateTo: this.$pubfunc.TimeTransform(
          'YYYY/MM/DD',
          this.$pubfunc.getTimeNum() + (7 - week) * onday
        ),
        customerName: '',
        projName: '',
        visitType: '',
      ...
      title: [
        ...
        { key: 'customerName', name: '客户名称', width: 20 },
        { key: 'contactName', name: '拜访对象', width: 16 },
        { key: 'visitTypeTxt', name: '拜访方式', width: 16 },
        { key: 'position', name: '职务', width: 16 },
        { key: 'cityName', name: '地区（城市）', width: 16 }
      ],
      title1: [
        { key: 'dateTime_', name: '拜访时间', width: 16 },
        ...
        { key: 'position', name: '职务', width: 14 },
        { key: 'cityName', name: '地区（城市）', width: 14 },
        { key: 'creatorName', name: '销售', width: 10 }
      ],
      list: [],
      ajaxIng: false,
      delLoading: false,
    ...
    tableOper (key, item) {
      ...
      switch (key) {
        ...
        case 'clear':
          ...
          break
        case 'add':
          this.$router.push({ name: 'visitplanAdd' })
          break
        case 'view':
          item.planId
            ? this.$router.push({
              name: 'visitplanView',
              params: { planId: this.$pubfunc.encode(item.planId) }
            })
            : null
          break
        case 'revise':
        ...
        case 'delete':
          this.$store.commit('confirmFn', {
            func: () => {
              ...
              this.$api.service.visit.deletePlan(
                { planId: item.planId },
                res => {
                  // console.log(res)
        ...
        case 'export':
          ...
          let param = JSON.parse(JSON.stringify(this.selRes))
          this.ajaxIng = true
          this.$api.download.visitPlanExport(param, res => {
