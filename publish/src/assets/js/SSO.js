...
const crossStorage = new Client("http://172.26.104.136:1111/", token => {
  console.log(token);
...
export function SSOLogout() {
  crossStorage.delItem(["token"], result => {});
}
